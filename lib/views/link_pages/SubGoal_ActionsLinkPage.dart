...
class LinkActionPage extends StatelessWidget {
  final int subGoalId;
  LinkActionPage({Key? key, required this.subGoalId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    controller.loadUnlinkedSubGoals(subGoalId);
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () {
                  _showWeightDialog(context, subGoal, subGoalId, controller);
                },
              ),
            );
          },
